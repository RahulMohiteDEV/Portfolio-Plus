      ...
      <div className="grid md:grid-cols-2 gap-gutter items-center">
        ...
        <div>
          ...
          <div className="space-y-6 font-body-lg text-on-surface-variant/80">
            <p>
              With a Master's in Computer Science and a strong foundation in JavaScript, TypeScript, and database management, I bring a blend of academic knowledge and practical experience to every project. I am committed to continuous learning and 
            </p>
            <p>
